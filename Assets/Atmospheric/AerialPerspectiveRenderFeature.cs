...
public class AerialPerspectiveRenderFeature : ScriptableRendererFeature
{
    ...
    public static Material material
    {
        ...
        {
            if (_Material == null)
                _Material = new Material(Shader.Find("Universal Render Pipeline/AerialPerspective"));
            return _Material;
        }
    }
    ...
    public override void Create()
    {
        ...
        m_ScriptablePass.aerialPerspectiveMaterial = material;
    }
    ...
    {
        if (AtmosphereInfoSettings.isAwake)
